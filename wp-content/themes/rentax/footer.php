<?php
    ...
    if (isset($GLOBALS['rentax_footer_type_page']) && $GLOBALS['rentax_footer_type_page']){
        $pix_footer_type_page = $GLOBALS['rentax_footer_type_page'];
    ...
    $footerStaticBlockGlobalID = rentax_get_option('footer_block');


    $bottomBlock = html_entity_decode(rentax_get_option('footer_settings_copyright', esc_html__('Copyright 2016. Design by Pix-Theme', 'rentax') ));
	$footer_logo = rentax_get_option('footer_logo','');
	$rentax_decor_class = rentax_get_option('footer_decor', '1') ? 'border-section-top border-section-top_mod-b' : '';
?>
        ...
        <section class="section_mod-h section-bg section-bg_second">
            <div class="bg-inner">
                <div class="container">
                    ...
                    <?php if ($footerStaticBlockID) rentax_get_staticblock_content($footerStaticBlockID) ?>

					<?php if (!$footerStaticBlockID && $footerStaticBlockGlobalID):?>
					         <?php echo rentax_get_staticblock_content($footerStaticBlockGlobalID)?>
					<?php endif; ?>
...
<div class="absolute-footer"><?php echo wp_kses_post( $bottomBlock ); ?></div>


<?php endif; ?>

<?php echo apply_filters('rentax_script_footer', ''); ?>
